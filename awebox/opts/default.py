...
def set_default_user_options():
    ...
    default_user_options_tree = [
        ...
        ('user_options',    'wind',        None,        'model',                 'log_wind',         ('possible options', ['log_wind', 'power', 'uniform', 'datafile','WRF']),'x'),
        ('user_options',    'wind',        None,        'u_ref',                 5.,                 ('reference wind speed [m/s]', None),'s'),
        ('user_options',    'wind',        None,        'WRF_winddata',          None,               ('WRF data for the wind at this time instant', None),'s'),
        ('user_options',    'wind',        None,        'WRF_heightsdata',       None,               ('WRF data for the heights at this time instant', None),'s'),
